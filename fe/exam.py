...
def build_prompt():
    ...
    return '\n'.join([
        ...
        *material_lines(),
        ...
        '',
        '【技術解説（notes）の書き方】',
        '- 学習モードで、問題を解く前に読む教材になる。問題の解説文とは別物',
        '- 設問・選択肢・正解には触れない。概念そのものをひとまとまりで説明する',
        '- 1本あたり600〜1200字。定義 → しくみ → 使いどころ → 混同しやすい概念との違い',
        '- その解説を読めば、同じ小分類の問題が解ける状態になることを目安にする',
        '- body は地の文で書く。箇条書きだけの羅列にしない',
        '',
        '【問題（questions）の規則】',
